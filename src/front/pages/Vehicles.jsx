...
export default function VehiclesServicePage() {
  ...
  const allProviders = [
    {
      id: 1,
      name: 'Crazy Lube Guys',
      service: 'Basic Oil Change',
      priceRange: '$30-$80',
      priceValue: 55,
      state: 'CA',
      town: 'San Francisco',
      email: 'info@crazylubeguys.com',
      phone: '(415) 555-0123',
      category: 'Oil Change'
    },
    {
      id: 2,
      name: 'Car Washers Plus',
      service: 'Car Washing',
      priceRange: '$25-$60',
      priceValue: 42,
      state: 'CA',
      town: 'Los Angeles',
      email: 'contact@carwasherplus.com',
      phone: '(213) 555-0456',
    ...
    },
    {
      ...
      state: 'NY',
      town: 'New York',
      email: 'contact@fastdetailers.com',
      phone: '(212) 555-0789',
        ...
        <div className="filter-controls">
          <div className="filter-select-wrapper">
            ...
            >
              ...
              <option>Vehicle Oil Change</option>
            </select>
